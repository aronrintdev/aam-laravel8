...
<div class="form-group">
    ...
    <p>{!! $academy->YT_UserName !!}</p>
</div>

<!-- Ratingflag Field -->
<div class="form-group">
    {!! Form::label('RatingFlag', 'Ratingflag:') !!}
    <p>{!! $academy->RatingFlag !!}</p>
</div>

<!-- Bodyfont Field -->
<div class="form-group">
    {!! Form::label('BodyFont', 'Bodyfont:') !!}
    <p>{!! $academy->BodyFont !!}</p>
</div>
...
<div class="form-group">
    ...
    <p>{!! $academy->LessonThreshold !!}</p>
</div>

<!-- Translate Field -->
<div class="form-group">
    {!! Form::label('Translate', 'Translate:') !!}
    <p>{!! $academy->Translate !!}</p>
</div>
